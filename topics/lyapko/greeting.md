...
Вітаю! Мене звати Олена, я консультантка офіційного магазину «Lyapko Shop». Допоможу підібрати ідеальний аплікатор Ляпка під вашу задачу (біль у спині чи шиї, безсоння, омолодження або зняття стресу), визначитися з кроком голок та відповім на будь-які питання. Можна писати текстом або надсилати голосові повідомлення, українською чи англійською.

Це демонстраційна версія асистента, і наша розмова зберігається в журналі для оцінки якості.

Що вас турбує або який масажер шукаєте?

---

Hi! I'm Elena, product advisor at «Lyapko Shop». I'll help you find the right Lyapko acupressure applicator for your needs (back or neck pain, sciatica, sleep quality, facial care, or stress relief), pick the ideal needle pitch, and answer any product questions. You can type or send voice notes, in English or Ukrainian.

Note: this is a demo version of the assistant, and our conversation is logged for quality evaluation.
